...
#include "claw_machine_msgs/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = claw_machine_msgs::msg::Position;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const claw_machine_msgs::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<claw_machine_msgs::msg::Position *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_claw_machine_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<claw_machine_msgs::msg::Position>()
{
  return &claw_machine_msgs::msg::typesupport_fastrtps_cpp::_Position__handle;
}
